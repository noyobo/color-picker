...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/Users/noyobo/home/github/color-picker/node_modules/rc-tools/node_modules/css-loader/index.js!/Users/noyobo/home/github/color-picker/assets/index.css", function() {
			var newContent = require("!!/Users/noyobo/home/github/color-picker/node_modules/rc-tools/node_modules/css-loader/index.js!/Users/noyobo/home/github/color-picker/assets/index.css");
	...
	var Picker = (function (_React$Component) {
	  ...
	  _createClass(Picker, [{
	    ...
	    value: function render() {
	      ...
	      })), React.createElement('div', { className: this.prefixClsFn('wrap-alpha') }, React.createElement(Alpha, {
	        alpha: this.state.alpha,
	        defaultColor: this.state.selectColor,
	        customColor: this.state.customColor,
	        onAlphaChange: this._onAlphaChange
	      })), React.createElement('div', { className: this.prefixClsFn('wrap-preview') }, React.createElement(Preview, {
	        alpha: this.state.alpha,
	        defaultColor: this.state.selectColor,
	        customColor: this.state.customColor
	      }))), React.createElement('div', { className: this.prefixClsFn('wrap'), style: { height: 40, marginTop: 6 } }, React.createElement(Params, {
	        defaultColor: this.state.selectColor,
	        alpha: this.state.alpha,
	        onAlphaChange: this._onAlphaChange,
	...
	var Alpha = (function (_React$Component) {
	  ...
	  _createClass(Alpha, [{
	    ...
	    value: function render() {
	      ...
	      }), React.createElement('span', { ref: 'point', style: { left: this.state.alpha + '%' } }), React.createElement('div', {
	        className: this.prefixClsFn('handler'),
	        onMouseDown: this.handleMouseDown
	      }));
	    }
